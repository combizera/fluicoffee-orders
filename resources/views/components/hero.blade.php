<section class="max-w-7xl mx-auto p-2 grid grid-cols-1 md:grid-cols-3 gap-4 items-center py-20 px-2">
  {{-- TITLE --}}
  <div class="flex flex-col items-start gap-4 col-span-1 md:col-span-2 animate-on-scroll">
    ...
    <x-btn.sec title="Solicite seu Orçamento" />
  </div>
  ...
  <div class="col-span-1 md:col-span-3 mt-8 animate-on-scroll">
    <img
